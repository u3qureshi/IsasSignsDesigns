...
export default function SweatshirtsFleecePage() {
  return (
    <main className="overflow-hidden bg-[hsl(var(--theme-kids-bg))] text-[hsl(var(--theme-brown-900))]">
      ...
      <section className="bg-[hsl(var(--theme-sand-300)/0.28)] px-6 py-20 sm:px-10 sm:py-28" aria-labelledby="sweatshirt-reviews-title">
        <div className="mx-auto max-w-[82rem] text-center">
          ...
          <h2 id="sweatshirt-reviews-title" className="mx-auto mt-3 max-w-4xl font-aoki text-[clamp(2.8rem,5vw,5.2rem)] leading-none">
          ...
          <article className="mx-auto mt-12 max-w-4xl rounded-[2rem] bg-white px-7 py-10 shadow-[0_18px_50px_rgba(50,31,21,0.08)] sm:px-12 sm:py-14">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base font-medium leading-7 text-[hsl(var(--theme-brown-700))] sm:text-lg sm:leading-8">
              We’re looking forward to sharing verified feedback from the people, teams, and organizations we create for. Check back soon for their experiences.
            </p>
